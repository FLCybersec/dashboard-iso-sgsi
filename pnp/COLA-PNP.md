...
| 2026-06-19 | pnp/Renombrar-Sitios-Juridico.ps1 | Intercambio de TITULOS (no URLs/slugs): "JMA Juridico" de Jorge (/sites/JMAJuridico) -> "Juridico Jorge"; SGSI-Juridico -> "JMA Juridico" | No (solo titulo, reversible; AUTORIZADO por Franco) | Corrido (ambos OK; 1 match unico; URLs intactas) | Code |
